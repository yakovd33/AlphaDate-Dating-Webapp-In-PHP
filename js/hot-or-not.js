    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response != 'not found') {
                ...
                var html = '<div class="hor-title">לא נמצאו עוד משתמשים התואמים את הנתונים שהזנת.<br>נסה שנית מאוחר יותר</div><img src="/img/icons/sad-love.png" height="120px" style="display: block; margin: 30px auto auto auto;">';
            }
